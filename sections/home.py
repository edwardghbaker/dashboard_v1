...
col1.image(r'data\josemaria-copper-gold-silver-project.jpg')

col2.image(r'data\Lundin_Logo.png')
col2.image(r'data\Logo-Mineria-Deprominsa.jpg')
col2.image(r'KP_stuff\KP-FullLogo-Colour-RGB.png')
